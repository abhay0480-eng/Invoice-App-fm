...
const AddInvoice = ({invoiceCount,handleOpen,filter,setFilter}) => {
  ...
  return (
    <div className='grid grid-cols-7 content-center my-5 md:mt-10'>
        ...
        <div    className='flex cursor-pointer justify-center items-center md:col-span-1 col-span-2 relative'>
        ...
        <div className='flex justify-end items-center col-span-2 ' >
            <button className='bg-[#7C5DFA] p-1 md:p-4 rounded-3xl text-[#fff] text-[15px] font-bold flex justify-center items-center' onClick={handleOpen}>
            ...
            <path d="M17.3131 21.0229V17.3131H21.0229V14.7328H17.3131V11.0229H14.7328V14.7328H11.0229V17.3131H14.7328V21.0229H17.3131Z" fill="#7C5DFA"/>
             ...
             <span className='mx-2 hidden md:block'> New Invoice</span>
             <span className='mx-2 block md:hidden'> New</span>
            </button>
        </div>
    </div>
  )
