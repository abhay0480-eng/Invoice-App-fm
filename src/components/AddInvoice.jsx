...
const AddInvoice = ({invoiceCount,handleOpen,filter,setFilter}) => {
  ...
  return (
    <div className='grid grid-cols-7 content-center my-5 lg:mt-10'>
        <div className='lg:col-span-4 col-span-3'>
            <h1 className= {`${theme?"text-[#fff]":"text-[#0C0E16]"} text-[24px] lg:text-[36px] font-bold`}>Invoices</h1>
        ...
        <div className='flex justify-end items-center col-span-2 ' >
            <button className='bg-[#7C5DFA] p-1 lg:p-4 rounded-3xl text-[#fff] text-[15px] font-bold flex justify-center items-center' onClick={handleOpen}>
            ...
            <path d="M17.3131 21.0229V17.3131H21.0229V14.7328H17.3131V11.0229H14.7328V14.7328H11.0229V17.3131H14.7328V21.0229H17.3131Z" fill="#7C5DFA"/>
             ...
             <span className='mx-2 hidden lg:block'> New Invoice</span>
             <span className='mx-2 block lg:hidden'> New</span>
            </button>
        </div>
    </div>
  )
